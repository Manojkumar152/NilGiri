...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.ViewHolder> {
    ...
    public AdminAdapter(Activity activity, List<AdminTdsCharge.DataBean> data) {
        list=data;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.adminCharge.setText(list.get(i).getAdmin_charge());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView amount, adminCharge,paid,date;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            amount=itemView.findViewById(R.id.amount);
            adminCharge=itemView.findViewById(R.id.admin_charge);
