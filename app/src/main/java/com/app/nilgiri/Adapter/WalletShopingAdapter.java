...
public class WalletShopingAdapter extends RecyclerView.Adapter<WalletShopingAdapter.MyHolder> {


    private Activity activity;
    private List<WalletDataShoppingModel.DataBean> list;

    public WalletShopingAdapter(Activity context, List<WalletDataShoppingModel.DataBean> data) {
    ...
    @NonNull
    @Override
    public WalletShopingAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.wallet_list_items, viewGroup, false);
        return new MyHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull WalletShopingAdapter.MyHolder myHolder, int i) {
